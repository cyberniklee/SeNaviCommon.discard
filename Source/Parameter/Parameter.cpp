...
namespace NS_NaviCommon
{
  ...
  std::string Parameter::getParameter(const std::string node_name, const std::string default_value)
  {
  ...
  int Parameter::getParameter(const std::string node_name, const int default_value)
  {
    char buf[16] = {0};
  ...
  float Parameter::getParameter(const std::string node_name, const float default_value)
  {
    char buf[16] = {0};
