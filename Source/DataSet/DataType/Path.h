...
namespace NS_DataType
{
  ...
  public:
    ...
    Path_ (const ContainerAllocator& allocator) : header(allocator), poses(allocator)
    {
    };

    DataHeader_<ContainerAllocator> header;
    std::vector<PoseStamped_<ContainerAllocator>, typename ContainerAllocator::template rebind<PoseStamped_<ContainerAllocator> >::other > poses;
