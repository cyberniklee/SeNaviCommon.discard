...
namespace NS_NaviCommon
{
  ...
  (const SingleSubscriberPublisher&)> SubscriberStatusCallback;
  ...
  {
    SubscriberCallbacks (const SubscriberStatusCallback& connect =
                             SubscriberStatusCallback (),
                         const SubscriberStatusCallback& disconnect =
                             SubscriberStatusCallback (),
  ...
  typedef boost::function<void
  (const TimerEvent&)> TimerCallback;
