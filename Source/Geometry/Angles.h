#ifndef _GEOMETRY_ANGLES_H_
#define _GEOMETRY_ANGLES_H_
...
namespace NS_Geometry
{
  namespace NS_Angles
  {
     ...
     */
    static inline double
    normalize_angle_positive (double angle)
    {
    ...
    static inline double
    shortest_angular_distance (double from, double to)
    {
     ...
     */
    static inline double
    two_pi_complement (double angle)
    {
     ...
     */
    static bool
    find_min_max_delta (double from, double left_limit, double right_limit,
     ...
     */
    static inline bool
    shortest_angular_distance_with_limits (double from, double to,
                                           double left_limit,
                                           double right_limit,
