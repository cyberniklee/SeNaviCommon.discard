...
#define TransformData TransformDoubleData
  ...
  public:
    ...
    /**@brief Return the basis matrix for the rotation */
    TFSIMD_FORCE_INLINE const Matrix3x3&
    getBasis () const
    {
      return m_basis;
    }
    ...
    void
    setFromOpenGLMatrix (const tfScalar *m)
    {
     ...
     * @param m A pointer to a 15 element array (12 rotation(row major padded on the right by 1), and 3 translation */
    void
    getOpenGLMatrix (tfScalar *m) const
    {
    ...
    TFSIMD_FORCE_INLINE Vector3
    invXform (const Vector3& inVec) const;

    /**@brief Set the rotational element by Matrix3x3 */
    TFSIMD_FORCE_INLINE void
    setBasis (const Matrix3x3& basis)
    {
      m_basis = basis;
    }
    ...
    Transform
    inverseTimes (const Transform& t) const;
    ...
    void
    serialize (struct TransformData& dataOut) const;

    void
    serializeFloat (struct TransformFloatData& dataOut) const;

    void
    deSerialize (const struct TransformData& dataIn);

    void
    deSerializeDouble (const struct TransformDoubleData& dataIn);

    void
    deSerializeFloat (const struct TransformFloatData& dataIn);
...
///for serialization
  ...
  TFSIMD_FORCE_INLINE void
  Transform::serialize (TransformData& dataOut) const
  {
  ...
  TFSIMD_FORCE_INLINE void
  Transform::deSerialize (const TransformData& dataIn)
  {
