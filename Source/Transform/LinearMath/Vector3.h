...
#ifndef _TRANSFORM_VECTOR3_H_
#define _TRANSFORM_VECTOR3_H_
...
#define Vector3DataName "Vector3DoubleData"
  ...
  public:
    ...
    TFSIMD_FORCE_INLINE tfScalar
    distance2 (const Vector3& v) const;
    ...
    TFSIMD_FORCE_INLINE Vector3
    rotate (const Vector3& wAxis, const tfScalar angle) const;
    ...
    absolute () const
    {
      return Vector3 (tfFabs (m_floats[0]), tfFabs (m_floats[1]),
                      tfFabs (m_floats[2]));
    }
    ...
    TFSIMD_FORCE_INLINE tfScalar
    triple (const Vector3& v1, const Vector3& v2) const
    {
      return m_floats[0]
          * (v1.m_floats[1] * v2.m_floats[2] - v1.m_floats[2] * v2.m_floats[1])
          + m_floats[1]
              * (v1.m_floats[2] * v2.m_floats[0]
                  - v1.m_floats[0] * v2.m_floats[2])
          + m_floats[2]
              * (v1.m_floats[0] * v2.m_floats[1]
    ...
    setInterpolate3 (const Vector3& v0, const Vector3& v1, tfScalar rt)
    {
    ...
    TFSIMD_FORCE_INLINE Vector3
    lerp (const Vector3& v, const tfScalar& t) const
    {
    ...
    TFSIMD_FORCE_INLINE const tfScalar&
    getX () const
    {
      return m_floats[0];
    }
    ...
    TFSIMD_FORCE_INLINE void
    setValue (const tfScalar& x, const tfScalar& y, const tfScalar& z)
    {
      m_floats[0] = x;
      m_floats[1] = y;
      m_floats[2] = z;
    ...
    void
    getSkewSymmetricMatrix (Vector3* v0, Vector3* v1, Vector3* v2) const
    {
      v0->setValue (0., -z (), y ());
      v1->setValue (z (), 0., -x ());
      v2->setValue (-y (), x (), 0.);
    ...
    isZero () const
    {
      return m_floats[0] == tfScalar (0) && m_floats[1] == tfScalar (0)
          && m_floats[2] == tfScalar (0);
    }
    ...
    TFSIMD_FORCE_INLINE void
    serialize (struct Vector3Data& dataOut) const;

    TFSIMD_FORCE_INLINE void
    deSerialize (const struct Vector3Data& dataIn);

    TFSIMD_FORCE_INLINE void
    serializeFloat (struct Vector3FloatData& dataOut) const;

    TFSIMD_FORCE_INLINE void
    deSerializeFloat (const struct Vector3FloatData& dataIn);

    TFSIMD_FORCE_INLINE void
    serializeDouble (struct Vector3DoubleData& dataOut) const;

    TFSIMD_FORCE_INLINE void
    deSerializeDouble (const struct Vector3DoubleData& dataIn);
  ...
  public:
    ...
    TFSIMD_FORCE_INLINE
    tfVector4 (const tfScalar& x, const tfScalar& y, const tfScalar& z,
               const tfScalar& w)
        : Vector3 (x, y, z)
    {
      m_floats[3] = w;
    ...
    absolute4 () const
    {
      return tfVector4 (tfFabs (m_floats[0]), tfFabs (m_floats[1]),
                        tfFabs (m_floats[2]), tfFabs (m_floats[3]));
    }
...
///tfSwapVector3Endian swaps vector endianness, useful for network and cross-platform serialization
  TFSIMD_FORCE_INLINE void
  tfSwapScalarEndian (const tfScalar& sourceVal, tfScalar& destVal)
  {
...
///tfSwapVector3Endian swaps vector endianness, useful for network and cross-platform serialization
  TFSIMD_FORCE_INLINE void
  tfSwapVector3Endian (const Vector3& sourceVec, Vector3& destVec)
  {
    for (int i = 0; i < 4; i++)
    {
...
///tfUnSwapVector3Endian swaps vector endianness, useful for network and cross-platform serialization
  TFSIMD_FORCE_INLINE void
  tfUnSwapVector3Endian (Vector3& vector)
  {
  ...
  TFSIMD_FORCE_INLINE void
  tfPlaneSpace1 (const Vector3& n, Vector3& p, Vector3& q)
  {
